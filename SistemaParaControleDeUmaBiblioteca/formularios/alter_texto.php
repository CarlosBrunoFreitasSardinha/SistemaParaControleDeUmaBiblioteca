...
require "constantes.php";
	   ...
	   echo "<form action=\"index.php?acao=".$VADT."\" method=\"post\">";
	$id_l_item=$_REQUEST['id_l'];
	
	include ("include/conect_banco.php");

	   $sql= mysql_query("SELECT * FROM texto WHERE id_acervo='$id_l_item' ") or die ("Erro no Comando SQL".mysql_error());
	   $SQL=mysql_fetch_array($sql);
	   $imprenta=$SQL['imprenta_texto'];
	   $ano=$SQL['ano_texto'];
	   $colecao=$SQL['tipo_colecao_texto'];
	   $idioma=$SQL['idioma_texto'];
	   $edicao=$SQL['edicao_texto'];
	   $tombo=$SQL['tombo'];
...
$sql= mysql_query("SELECT * FROM acervo WHERE id_acervo='$id_l_item' ") or die ("Erro no Comando SQL".mysql_error());
	...
	<tr height="25">
   	  ...
   	  <td width="160"><?php echo "<input type=\"text\" size=\"22\" value=\"".$ano."\" name=\"ano\"/>";?></td>			
	</tr>
	...
	<tr height="25">
		...
		<tr height=\"25\">
          ...
          echo "<td><input name=\"serie\" size=\"25\" value=\"".$serie."\" type=\"text\"/></td>";
		  
          echo "<td height=\"24\">Edi&ccedil;&atilde;o:</td>";
