<?php
			...
			$z=mysql_query("UPDATE editora SET editora='$name' WHERE id_editora='$identificador'")or die("Erro no Comando SQL: ".mysql_error());
		echo "<center><table border=\"0\" cellspacing=\"0\" cellpading=\"0\" width=\"560\">
							<tr>
								<td colspan=\"2\" bgcolor=\"#000000\"><font color=\"#ffffff\"><b><center>Editoras</td></tr>";
		include("include/conect_banco.php");
			...
			$nome[$i]=$sql['editora'];
									...
									if (($i%2)=='1'){
										echo "<tr onMouseOut=\"this.style.background=''\"  onmouseover=\"this.style.background='#9EDAB0';\" bgcolor=\"#EBEBEB\" height=\"20\">
												<td width=\"25\"><center><a href=\"index.php?acao=$ADE&&editora=".$id_autor[$i]."\"><img src=\"images/b_edit.png\"></a></td>
												<td><center><font size=\"2\">".$nome[$i]."</td></tr>";
									 }
									if (($i%2)=='0'){//bgcolor=\"#C4DBDB\"azul legal
										echo "<tr onMouseOut=\"this.style.background=''\"  onmouseover=\"this.style.background='#9EDAB0';\" bgcolor=\"#CAC8C8\">
												<td><center><a href=\"index.php?acao=$ADE&&editora=".$id_autor[$i]."\"><img src=\"images/b_edit.png\"></a></td>
