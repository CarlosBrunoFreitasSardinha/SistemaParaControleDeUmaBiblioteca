...
//tabela de livros	
					echo "<center><table border=\"0\" cellspacing=\"0\" cellpading=\"0\" width=\"560\">
							<tr>
								<td colspan=\"4\" bgcolor=\"#000000\"><font color=\"#ffffff\"><b><center>Textos e Anuários</td></tr>
							<tr>
								...
								for ($i=0;$i < $lin4;$i++){
									if (($i%2)=='1'){
										echo "<tr bgcolor=\"#EBEBEB\">
												<td><center><font size=\"2\">".$titulo_acervo_texto[$i]."</td>
												<td><center><font size=\"2\"><font size=\"2\">";
												for ($t=0;$t< $qt;$t++){
													if($tipo4[$i]==$nomes_editoras[$t][1]) echo $nomes_editoras[$t][0];
												}echo "</td>";
										echo "  <td><center><font size=\"2\">".$assuntos_acervo_texto[$i]."</td>
												<td><center><font size=\"2\">".$quantidade_aquisicao_texto[$i]."</td>
											    </tr>";
									 }
									if (($i%2)=='0'){
										echo "<tr bgcolor=\"#CAC8C8\">
												<td><center><font size=\"2\">".$titulo_acervo_texto[$i]."</font></td>
